...
public class QR_Scan extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    public void run() {
        do {
            ...
            try {
                ...
                // Không tìm thấy mã QR, tiếp tục vòng lặp
            }

            if (result != null) {
                // Lấy kết quả và hiển thị
                qrResult = result.getText();
                System.out.println("QR Code đã quét: " + qrResult);

                // Đặt kết quả vào trường result_field (nếu cần)
                result_field.setText(qrResult);
    ...
    public String getQrResult() {
        return qrResult; // Trả về kết quả quét
    }
    @Override
